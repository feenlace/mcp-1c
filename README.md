...
> **Расширенная версия** — 15 дополнительных инструментов: оптимизатор запросов, линтер BSL (30 диагностик), анализ кода, справочник платформы, работа с расширениями, long polling и другие.
> Пробный период 14 дней. [Подробнее на feenlace.ru](https://feenlace.ru)
