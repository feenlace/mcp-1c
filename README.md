...
>
> Этой сборке нужно расширение версии 0.4.7 или новее. Более старое запуску не мешает: сервер работает, но пишет в журнал `Extension is OLDER than this build requires`, и часть инструментов будет отвечать ошибкой.
