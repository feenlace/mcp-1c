...
// которые этот репозиторий производит или называет, это
// "application/json; charset=utf-8" (cmd/mock-1c) и "text/html" (образец
// страницы IIS в tools/toolerror_test.go), а их именные части занимают 16 и 9
// рун. Шестьдесят четыре это вчетверо больше длинной из двух. Значение длиннее
// описывается, а не показывается.
//
